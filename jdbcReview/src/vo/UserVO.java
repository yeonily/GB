...
public class UserVO {
	...
	public String toString() {
		return "UserVO [userNumber=" + userNumber + ", userId=" + userId + ", userName=" + userName + ", userPassword="
				+ userPassword + ", userPhone=" + userPhone + ", userNickname=" + userNickname + ", userEmail="
				+ userEmail + ", userAddress=" + userAddress + ", userBirthDate=" + userBirthDate + ", userGender="
				+ userGender + ", userRecommenderId=" + userRecommenderId + ", userJob=" + userJob + "]";
	}
