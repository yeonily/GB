...
//			연결에 필요한 정보
			...
			String url = "jdbc:mysql://localhost:3306/customer"; // 직접 url을 써줘야 함. url = DBMS를 접근할 수 있는 경로.
			
//			드라이버를 메모리에 할당
			//jar파일에 드라이버가 있음.
			Class.forName("com.mysql.cj.jdbc.Driver"); // 경로가 잘못되어 있으면 ClassNotFoundException 발생. try-catch잡아줘야 함.
